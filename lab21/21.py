...
class Main_Window():
    def __init__(self):
        ...
        self.root.title("Студенческая библиотека")
        ...
        self.ref_menu.add_command(label="Жанры", command=self.open_win_provider)
        self.ref_menu.add_command(label="Название книги")
        self.ref_menu.add_command(label="Инвентарный номер")
        self.ref_menu.add_command(label="Авторы")
        self.ref_menu.add_command(label="Год издания")
        self.ref_menu.add_command(label="Издательства")
        self.ref_menu.add_command(label="Места издания")
        self.ref_menu.add_command(label="Количество страниц")
...
class Provider_Window():
    ...
    def __init__(self):
        ...
        self.root2.title("Студенческая библиотека")
